...
public enum StatusCode implements EnumStatus {
    ...
    OTHER_ERROR(-1001, "其他异常"),
    SYSTEM_ERROR(-1002,"系统异常"),
    PARAM_ERROR(-1003, "参数不正确"),
    DATABASE_ERROR(-1004, "数据库异常"),
    ENCRYPT_ERROR(-1005, "加解密异常"),
    CACHE_ERROR(-1006, "缓存异常"),
    UNAUTHORIZED_ERROR(-1007, "未授权"),
    NOT_FOUND_ERROR(-1008,"请求不存在"),
    MAXIMUM_UPLOAD_SIZE_ERROR(-1009,"上传文件太大"),
    MEDIATYPE_ERROR(-1010,"MediaType错误"),;
